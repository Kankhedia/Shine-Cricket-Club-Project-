    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar-collapse-man">
        <ul class="nav navbar-nav navbar-right">
          <li><a class="" id="join-homepage" href="../Join/join.php">Login</a></li>
          <li><a class="" id="join-homepage" href="../Join/admin.php">Admin Login</a></li>
        </ul>
      </div>
    </div>
  </nav>
  ...
  <div class="padding">
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
          <img src="img/bd1.png" alt="" class="img-responsive">
        </div>
      </div>
    </div>
  </div>
