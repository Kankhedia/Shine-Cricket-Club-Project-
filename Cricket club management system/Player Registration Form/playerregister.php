<?php
  ...
  if(isset($_POST['player-reg-button'])){
    ...
    $pr_house = mysqli_real_escape_string($db, $_POST['pr_regno']);
    $pr_location = mysqli_real_escape_string($db, $_POST['pr_location']);
    $pr_village = mysqli_real_escape_string($db, $_POST['pr_state']);
    $pr_thana = mysqli_real_escape_string($db, $_POST['pr_city']);
    $pr_district = mysqli_real_escape_string($db, $_POST['pr_district']);
    $pr_postcode = mysqli_real_escape_string($db, $_POST['pr_pincode']);

    $per_house = mysqli_real_escape_string($db, $_POST['per_regno']);
    $per_location = mysqli_real_escape_string($db, $_POST['per_location']);
    $per_village = mysqli_real_escape_string($db, $_POST['per_state']);
    $per_thana = mysqli_real_escape_string($db, $_POST['per_city']);
    $per_district = mysqli_real_escape_string($db, $_POST['per_district']);
    $per_postcode = mysqli_real_escape_string($db, $_POST['per_pincode']);
    $dob = mysqli_real_escape_string($db, $_POST['dob']);


       $sql = "INSERT INTO playerreg (firstname, middlename, lastname, fathername, mothername, pr_regno, pr_location, pr_state, pr_city, pr_district, pr_pincode, per_regno, per_location, per_state, per_city, per_district, per_pincode, dob) VALUES ('$firstname', '$middlename', '$lastname', '$fathername', '$mothername', '$pr_regno', '$pr_location', '$pr_state', '$pr_city', '$pr_district', '$pr_pincode', '$per_regno', '$per_location', '$per_state', '$per_city', '$per_district', '$per_pincode', '$dob')";
