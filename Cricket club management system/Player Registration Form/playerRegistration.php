    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar-collapse-man">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="../Contract Form/contractForm.php">Ground Booking</a></li>
        ...
        <div class="formBox">
          <form action="playerRegistration.php" method="post" role="form">
            <div class="row">
              ...
              <div class="col-sm-4">
                <div class="inputBox">
                  <div class="inputText">House /Flat No.</div>
                  <input type="text" name="pr_regno" class="input">
                </div>
              </div>
              <div class="col-sm-4">
                <div class="inputBox">
              ...
              <div class="col-sm-4">
                <div class="inputBox">
                  ...
                  <input type="text" name="pr_state" class="input">
                </div>
              </div>
              ...
              <div class="col-sm-4">
                <div class="inputBox">
                  ...
                  <input type="text" name="pr_city" class="input">
                </div>
              </div>
              ...
              <div class="col-sm-4">
                <div class="inputBox">
                  ...
                  <input type="text" name="pr_pincode" class="input">
                </div>
              </div>
              ...
              <div class="col-sm-4">
                <div class="inputBox">
                  <div class="inputText">House /Flat No.</div>
                  <input type="text" name="per_regno" class="input">
                </div>
              </div>
              <div class="col-sm-4">
                <div class="inputBox">
              ...
              <div class="col-sm-4">
                <div class="inputBox">
                  <div class="inputText">State</div>
                  <input type="text" name="per_state" class="input">
                </div>
              </div>
              ...
              <div class="col-sm-4">
                <div class="inputBox">
                  <div class="inputText">City</div>
                  <input type="text" name="per_city" class="input">
                </div>
              </div>
              ...
              <div class="col-sm-4">
                <div class="inputBox">
                  <div class="inputText">Pin code</div>
                  <input type="text" name="per_pincode" class="input">
                </div>
              </div>
              <div class="col-sm-6">
                <div class="inputBox">
              ...
              <table id="form-table" class="table table-striped">
                ...
                <tbody id="table-body">
                  <tr>
                    <td><input class="col-xs-12" type="text" name="clubname_01" value="" placeholder=""></td>
                    <td><input class="col-xs-12" type="text" name="club_from_01" value="" placeholder=></td>
                    <td><input class="col-xs-12" type="text" name="club_to_01" value="" placeholder=""></td>
                    <td><input class="col-xs-12" type="text" name="total_run_01" value="" placeholder=""></td>
                    <td><input class="col-xs-12" type="text" name="total_wicket_01" value="" placeholder=""></td>
              ...
              <table id="form-table" class="table table-striped">
                ...
                <tbody id="table-body">
                  <tr>
                    <td><input class="col-xs-12" type="text" name="bp_clubname_01" value="" placeholder=""></td>
                    <td><input class="col-xs-12" type="text" name="bp_opp_club_01" value="" placeholder=""></td>
                    <td><input class="col-xs-12" type="text" name="bp_eventid_01" value="" placeholder=""></td>
                    <td><input class="col-xs-12" type="text" name="bp_match_id_01" value="" placeholder=""></td>
                    <td><input class="col-xs-12" type="text" name="bp_run_01" value="" placeholder=""></td>
                    <td><input class="col-xs-12" type="text" name="bp_wicket_01" value="" placeholder=""></td>
                  </tr>
                  <tr>
              ...
              <div class="radio">
                <label><input type="radio" name="member-radio" value="iccb">Under-19</label>
              </div>
              <div class="radio">
                <label><input type="radio" name="member-radio" value="bccb">Under-17</label>
              </div>
              <div class="radio">
                <label><input type="radio" name="member-radio" value="accb">Under-15</label>
              </div>
              <div class="radio">
