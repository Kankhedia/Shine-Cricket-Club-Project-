    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbar-collapse-man">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a class="active" href="../Contract Form/contractForm.php">Ground Booking</a></li>
        ...
        <div class="formBox">
          <form action="contractForm.php" method="post" role="form">
            <div class="row">
              ...
              <!--   CONTRACT PERIOD   --->
              <div class="col-sm-12">
                <h4 class="name-player">Period of Booking</h4>
              </div>
              <div class="col-sm-6">
                <div class="inputBox">
              ...
              <div class="col-sm-6">
                <div class="inputBox">
                  <div class="inputText"> Amount</div>
              ...
              <table id="form-table" class="table table-striped">
                ...
                <tbody id="table-body">
                  ...
                  <tr>
                    <td><input class="col-xs-4" type="text" name="serial_no_01" value="" placeholder=""></td>
                    ...
                    <td><input class="col-xs-7" type="text" name="amount_01" value="" placeholder=""></td>
                  </tr>
                  <tr>
              ...
              <div class="col-sm-12">
                <input type="submit" class="contract-button" name="contract-form-button" value="CONFIRM" echo ="Booking confirmed">
              </div>
            </div>
          </form>
        </div>
